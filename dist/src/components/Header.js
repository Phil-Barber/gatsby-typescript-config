...
`;
exports.Header = ({ title }) => (react_1.default.createElement("div", { css: style.container },
    react_1.default.createElement("div", { css: style.wrapper },
        react_1.default.createElement("h1", { css: style.title },
