...
exports.LunrSearch = ({ limit }) => {
    ...
    return (react_1.default.createElement("div", { ref: ref, css: styles.wrapper },
        react_1.default.createElement("label", null,
            react_1.default.createElement("span", { css: styles.hidden }, "Search"),
            react_1.default.createElement("input", { type: "search", css: styles.input, value: query, onChange: (event) => {
                    setQuery(event.target.value);
                    setResults(search(event.target.value));
                    setActive(true);
                } })),
        isActive ? (react_1.default.createElement("ul", { css: styles.list },
            results.slice(0, limit).map((result, index) => (react_1.default.createElement("li", { key: index, css: styles.item },
                react_1.default.createElement(gatsby_1.Link, { css: styles.link, to: result.path }, result.title)))),
            react_1.default.createElement("li", { css: styles.footer },
                "Showing ",
