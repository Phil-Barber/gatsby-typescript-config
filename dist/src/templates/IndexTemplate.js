...
const IndexTemplate = ({ data, pageContext }) => (react_1.default.createElement(Layout_1.Layout, null,
    react_1.default.createElement(react_helmet_1.Helmet, { meta: [
    ...
    react_1.default.createElement(Pager_1.Pager, { page: pageContext.page, prefix: pageContext.prefix, total: pageContext.pageTotal }),
