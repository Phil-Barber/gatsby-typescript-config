...
const TagsPage = ({ data }) => {
    return (react_1.default.createElement(Layout_1.Layout, null,
        ...
        react_1.default.createElement("div", null,
            ...
            react_1.default.createElement("ul", null, data.allMdx.group.map(({ tag, totalCount }) => (react_1.default.createElement("li", { key: tag },
                react_1.default.createElement(gatsby_1.Link, { to: `/tags/${lodash_1.kebabCase(tag)}/` }, tag),
                " (",
                totalCount,
                ")")))))));
};
