...
describe('LunrSearch', () => {
    ...
    it('displays search results from the global Lunr index', () => {
        ...
        const { getByText, queryByText, getByLabelText } = react_2.render(react_1.default.createElement(LunrSearch_1.LunrSearch, null));
    ...
    it('limit number of search results displayed', () => {
        ...
        const { getByText, getAllByText, getByLabelText } = react_2.render(react_1.default.createElement(LunrSearch_1.LunrSearch, { limit: 2 }));
    ...
    it('shows the number of results if limit is greater', () => {
        ...
        const { getByText, getByLabelText } = react_2.render(react_1.default.createElement(LunrSearch_1.LunrSearch, { limit: 9999 }));
        change(getByLabelText('Search'), 'number');
    ...
    it('hides search results on clicking outside the component', () => {
        ...
        const { queryByText, getByLabelText, getByTestId } = react_2.render(react_1.default.createElement("div", null,
