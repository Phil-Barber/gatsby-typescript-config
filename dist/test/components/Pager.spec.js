...
describe('<Pager />', () => {
    it('renders a pager for the first page', () => {
        const { getByText } = react_2.render(react_1.default.createElement(Pager_1.Pager, { page: 1, prefix: "prefix", total: 3 }));
        expect(getByText('Next').getAttribute('href')).toBe('/prefix/2');
    });
    it('renders a pager for the second page', () => {
        const { getByText } = react_2.render(react_1.default.createElement(Pager_1.Pager, { page: 2, prefix: "prefix", total: 3 }));
    ...
    it('renders a pager for the last page', () => {
        const { getByText } = react_2.render(react_1.default.createElement(Pager_1.Pager, { page: 3, prefix: "prefix", total: 3 }));
